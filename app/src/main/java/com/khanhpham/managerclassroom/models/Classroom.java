...
public class Classroom {
    ...
    public Classroom(int status, String floorName, String roomName, String date_study, String time_study, String time_signup, String teacher, String subject, String report, DeviceClassroom deviceClassroom) {
        this.status = status;
